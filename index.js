  ...
  const posts = [
    {
      ...
      contents: [
        "A futuristic humanoid robot with advanced features, designed to assist in various industries like healthcare, manufacturing, and customer service.",
      ...
      description:
        " Technology is continuously transforming our lives through AI, automation, and connectivity, making tasks faster, easier, and more efficient. From robotics to virtual reality, it’s reshaping industries and enhancing human experiences.",
    },
    {
      id: 2,
      title: "Travel",
      ...
      contents: [
        "A hiker standing on a mountain peak, overlooking vast landscapes, representing the thrill of adventure travel and exploring nature.",
      ...
      description:
        " Travel has become more accessible and diverse, with technology allowing for seamless booking and exploration of global destinations. Whether for adventure or relaxation, travel offers opportunities to connect with new cultures and experience",
    },
    {
      id: 3,
      title: "Food",
      ...
      contents: [
        "A close-up of a decadent chocolate cake with rich frosting, symbolizing indulgence and the sweet side of life.",
      ...
      description:
        "  Food  is revolutionizing the way we produce, process, and consume food, with innovations such as lab-grown meat and smart kitchens. These advancements are helping to improve food safety, sustainability, and efficiency in the industry.",
    },
    {
      id: 4,
      title: "Lifestyle",
      ...
      contents: [
        " A peaceful morning scene showing a cup of coffee, a cozy blanket, and a planner, symbolizing the start of a productive day focused on well-being.",
      ...
      description:
        "  Modern lifestyles focus on achieving balance, wellness, and sustainability, with many people embracing healthier habits and eco-friendly choices. This shift is evident in trends like fitness routines, mindful living, and minimalist design.",
    },
  ];
